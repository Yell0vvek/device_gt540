...
#GAPPS
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/prebuilt/gapps/app/CarHomeLauncher.apk:system/app/CarHomeLauncher.apk \
	$(LOCAL_PATH)/prebuilt/gapps/app/FOTAKill.apk:system/app/FOTAKill.apk \
	$(LOCAL_PATH)/prebuilt/gapps/app/GenieWidget.apk:system/app/GenieWidget.apk \
	...
	$(LOCAL_PATH)/prebuilt/gapps/app/GoogleQuickSearchBox.apk:system/app/GoogleQuickSearchBox.apk \
	$(LOCAL_PATH)/prebuilt/gapps/app/GoogleServicesFramework.apk:system/app/GoogleServicesFramework.apk \
	$(LOCAL_PATH)/prebuilt/gapps/app/LatinImeTutorial.apk:system/app/LatinImeTutorial.apk \
	...
	$(LOCAL_PATH)/prebuilt/gapps/app/Talk.apk:system/app/Talk.apk \
	$(LOCAL_PATH)/prebuilt/gapps/app/Vending.apk:system/app/Vending.apk \
	$(LOCAL_PATH)/prebuilt/gapps/etc/permissions/features.xml:system/etc/permissions/features.xml \
	$(LOCAL_PATH)/prebuilt/gapps/etc/permissions/com.google.android.maps.xml:sytem/etc/permissions/com.google.android.maps.xml \
	$(LOCAL_PATH)/prebuilt/gapps/framework/com.google.android.maps.jar:system/framework/com.google.android.maps.jar \
	$(LOCAL_PATH)/prebuilt/gapps/lib/libvoicesearch.so:system/lib/libvoicesearch.so
